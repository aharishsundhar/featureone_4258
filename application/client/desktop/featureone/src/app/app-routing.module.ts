...
{ path : 'addscreen', loadChildren: () => import('./addscreen/addscreen.module').then(m => m.AddscreenModule), canActivate: [AuthGuard] } , 
{ path : 'allscreen', loadChildren: () => import('./allscreen/allscreen.module').then(m => m.AllscreenModule), canActivate: [AuthGuard] } , 
